    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item" style="color: #fff !important;">
                    <a href="std_dashboard.php" class="nav-link" style="color: #fff !important;">
                ...
                <li class="nav-item" style="color: #fff !important;">
                    <a href="std_enrolled_units.php" class="nav-link" style="color: #fff !important;">
                ...
                <li class="nav-item" style="color: #fff !important;">
                    <a href="std_manage_payments.php" class="nav-link" style="color: #fff !important;">
                ...
                <li class="nav-item" style="color: #fff !important;">
                    <a href="std_study_materials.php" class="nav-link" style="color: #fff !important;">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item" style="color: #fff !important;">
                            <a href="std_questions_bank.php" class="nav-link" style="color: #fff !important;">
                                <i class="fas fa-chevron-right nav-icon"></i>
                                <p>Questions</p>
                            </a>
                        </li>
                        <li class="nav-item" style="color: #fff !important;">
                            <a href="std_answers_bank.php" class="nav-link" style="color: #fff !important;">
                                <i class="fas fa-chevron-right nav-icon"></i>
                                <p>Answers</p>
                            </a>
                        </li>
                ...
                <li class="nav-item" style="color: #fff !important;">
                    <a href="std_marks.php" class="nav-link" style="color: #fff !important;">
                ...
                <li class="nav-item" style="color: #fff !important;">
                    <a href="std_certificates.php" class="nav-link" style="color: #fff !important;">
