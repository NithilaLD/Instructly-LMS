                                    ...
                                    <div class="modal-dialog  modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">
                                                    Allowed file types: XLS, XLSX. <br>Please, Refer The Format from The Sample File<br><a href="../public/sys_data/uploads/xls/Instructors_Template.xlsx">Download The Sample File</a>
                                                </h4>
