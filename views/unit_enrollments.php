...
if (isset($_POST['enroll_student'])) {
    ...
    if (!$error) {
        $stmt = $mysqli->prepare("SELECT * FROM lms_enrollments WHERE s_regno = ? AND s_unit_code = ?");
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if (($s_regno == $row['s_regno']) && ($s_unit_code == $row['s_unit_code'])) {
                $unit_name_display = isset($s_unit_name) ? $s_unit_name : (isset($row['s_unit_name']) ? $row['s_unit_name'] : 'this unit');
                $err = (isset($s_name) ? $s_name : 'Student') . " Already Enrolled To " . $unit_name_display;
            }
        } else {
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-outline-warning" data-toggle="modal" href="#delete-<?php echo $enrollments->en_id; ?>">
