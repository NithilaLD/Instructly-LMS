...
if (isset($_POST['Register'])) {
    $error = 0;
    $i_number = $i_name = $i_email = $i_phone = $i_pwd = '';
                ...
                <div class="card-body">
                    ...
                    <form method="post">
                        <div class="input-group mb-3">
                            <input type="text" required name="i_name" class="form-control" placeholder="Full Names" id="i_name" autocomplete="name">
                            <input type="hidden" required name="i_number" value="<?php echo date('Y') . rand(1000, 9999); ?>" id="i_number">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" required name="i_phone" class="form-control" placeholder="Phone Number" id="i_phone" autocomplete="tel">
                            <div class="input-group-append">
                                <div class="input-group-text">
                        ...
                        <div class="input-group mb-3">
                            <input type="email" required name="i_email" class="form-control" placeholder="Email" id="i_email" autocomplete="email">
                            <div class="input-group-append">
                                <div class="input-group-text">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" required name="i_pwd" class="form-control" placeholder="Password" id="i_pwd" autocomplete="current-password">
                            <div class="input-group-append">
                                <div class="input-group-text">
