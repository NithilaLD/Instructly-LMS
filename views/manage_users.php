...
if (isset($_GET['approve']) && is_numeric($_GET['approve'])) {
    ...
    if ($stmt->execute()) {
        logAuditAction($mysqli, 'approve_user', 'User approved', 'manage_users', 'user', (string) $verify_user_id);
...
if (isset($_GET['reject']) && is_numeric($_GET['reject'])) {
    ...
    if ($stmt->execute()) {
        logAuditAction($mysqli, 'reject_user', 'User deactivated', 'manage_users', 'user', (string) $reject_user_id);
