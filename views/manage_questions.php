<?php
    ...
    if ($role === 'admin' && isset($_GET['delete'])) {
        ...
        $stmt = $mysqli->prepare("DELETE FROM questions WHERE q_id = ?");
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Edit Question Bank <?php echo h($question->q_code); ?></h4>
                                                                    ...
                                                                    <form method="post" enctype="multipart/form-data">
                                                                        <div class="row">
                                                                            <div class="form-group col-md-12">
                                                                                <label for="q_code">Question Bank Code</label>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body text-center text-danger">
                                                                        <h4>Delete <?php echo h($question->q_code); ?> Bank?</h4>
                                                                        <br>
