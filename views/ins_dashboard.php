                        ...
                        <div class="row">
                                ...
                                <div class="info-box mb-3">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            <?php
                                            $i_id = $_SESSION['i_id'];
                                            $ret = "SELECT COUNT(*) AS total FROM lms_enrollments WHERE i_id = '$i_id'";
                                            $stmt = $mysqli->prepare($ret);
                                            $stmt->execute();
                                            $res = $stmt->get_result();
                                            $students_enrollments = $res->fetch_object()->total;
                                            echo $students_enrollments;
                                            ?>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="info-box mb-3">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            <?php
                                            $i_id = $_SESSION['i_id'];
                                            $ret = "SELECT COUNT(*) AS total FROM lms_units_assaigns WHERE i_id = '$i_id'";
                                            $stmt = $mysqli->prepare($ret);
                                            $stmt->execute();
                                            $res = $stmt->get_result();
                                            $allocated_units = $res->fetch_object()->total;
                                            echo $allocated_units;
                                            ?>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="info-box mb-3">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Payments Recieved</span>
