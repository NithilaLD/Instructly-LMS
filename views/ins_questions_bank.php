                    ...
                    <div class="container-fluid">
                        <div class="container">
                            <div class="text-right text-dark">
                                <a class="btn btn-outline-warning" href="ins_manage_questions_bank.php">Manage Questions Bank</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                    ...
                                    <table id="dash-1" class="table table-striped table-bordered display no-wrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            while ($units = $res->fetch_object()) {
                                                /* Generate a unique question code for the form (avoid undefined variables $a and $b) */
                                                $q_code_generated = 'Q-' . substr(md5(uniqid((string) mt_rand(), true)), 0, 8);
                                            ?>
                                                <tr>
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <input type="text" id="c_name" name="c_name" value="<?php echo $units->c_name; ?>" readonly required class="form-control" autocomplete="name">
                                                                                    <!-- Hidden Values -->
                                                                                    <input type="hidden" id="c_id" name="c_id" value="<?php echo $units->c_id; ?>" readonly required class="form-control">
                                                                                    <input type="hidden" id="cc_id" name="cc_id" value="<?php echo $units->cc_id; ?>" readonly required class="form-control">
                                                                                    <input type="hidden" id="i_id" name="i_id" value="<?php echo $units->i_id; ?>" readonly required class="form-control">
                                                                                </div>
                                                                                <div class="form-group col-md-6">
                                                                                    <label for="c_code">Unit Code</label>
                                                                                    <input type="text" id="c_code" name="c_code" readonly value="<?php echo $units->c_code; ?>" required class="form-control" autocomplete="on">
                                                                                </div>

                                                                                <div class="form-group col-md-6" style="display:none">
                                                                                    <label for="q_code">Questions Code</label>
                                                                                    <input type="text" id="q_code" name="q_code" readonly value="<?php echo $q_code_generated; ?>" required class="form-control" autocomplete="on">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="form-group col-md-12">
                                                                                    <label for="q_details">Questions</label>
                                                                                    <textarea type="text" id="q_details" name="q_details" class="form-control" id="<?php echo $units->ua_id; ?>"></textarea autocomplete="on">
                                                                                </div>
                                                                            </div>
                                                                            <hr>
