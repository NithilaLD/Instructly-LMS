...
if (isset($_POST['update_question_bank'])) {
    ...
    if (!$error) {
        ...
        $rc = $stmt->bind_param('sss', $q_details, $q_code, $q_id);
        $stmt->execute();
        if ($stmt) {
                    ...
                    <div class="container-fluid">
                        <!-- <div class="container">
                            <div class="text-right text-dark">
                                <a class="btn btn-outline-warning" href="ins_questions_bank.php">Add Questions Bank</a>
                            </div>
                        </div>
                        <hr> -->
                        <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-outline-warning" href="ins_view_bank.php?view=<?php echo $questions->q_id; ?>">
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="form-group col-md-12">
                                                                                    <label for="q_id">Questions Bank Code</label>
                                                                                    <!-- Hidden Values -->
                                                                                    <input type="hidden" id="q_id" name="q_id" value="<?php echo $questions->q_id; ?>" readonly required class="form-control">
                                                                                    <input type="text" name="q_code" id="q_code" readonly value="<?php echo $questions->q_code; ?>" required class="form-control" autocomplete="on">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="form-group col-md-12">
                                                                                    <label for="q_details">Questions</label>
                                                                                    <textarea type="text" id="q_details" name="q_details" class="form-control" id="editor-<?php echo $questions->q_id; ?>"><?php echo $questions->q_details; ?></textarea autocomplete="on">
                                                                                </div>
                                                                            </div>
                                                                            <hr>
