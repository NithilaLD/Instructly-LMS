                                ...
                                <div class="card-body">
                                    <table id="dash-1" class="table table-striped table-bordered display no-wrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if ($res->num_rows == 0) {
                                                echo '<tr><td colspan="6" class="text-center text-muted"><br><strong>No verified materials available yet.</strong><br>Your payments are still pending verification by the instructor.<br><br></td></tr>';
                                            }
