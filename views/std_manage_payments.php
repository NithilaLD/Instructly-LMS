                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php
                                                                $hasVerifiedLater = false;

                                                                if ($payments->p_verification_status == 'rejected') {
                                                                    $ls_id = $payments->ls_id;
                                                                    $rejectedDate = $payments->p_date_paid;
                                                                    ...
                                                                    if ($checkRes->num_rows > 0) {
                                                                        $hasVerifiedLater = true;
                                                                    }
                                                                }

                                                                if ($payments->p_verification_status == 'rejected' && !$hasVerifiedLater) {
                                                                ?>
