...
if (isset($_POST['add_unit'])) {
    ...
    $cc_id = $c_code = $c_name = $c_category = $c_desc = '';
    ...
    if (!$error) {
        ...
        $stmt = $mysqli->prepare("SELECT * FROM lms_course WHERE c_code = ?");
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            $query = "INSERT INTO lms_course (cc_id, a_id, c_name, c_code, c_category, c_desc) VALUES (?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc = $stmt->bind_param('ssssss', $cc_id, $a_id, $c_name, $c_code, $c_category, $c_desc);
            $stmt->execute();
            if ($stmt) {
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name="c_code" required class="form-control" id="c_code" autocomplete="on">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-outline-warning" href="view_unit.php?view=<?php echo $units->c_id; ?>">
                                                            <i class="fas fa-external-link-alt"></i>
                                                            View
                                                        </a>

                                                        <a class="badge badge-outline-warning" data-toggle="modal" href="#update-<?php echo $units->c_id; ?>">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                                <div class="form-group col-md-6">
                                                                                    <label for="c_name">Unit Name</label>
                                                                                    <input type="text" name="c_name" required value="<?php echo $units->c_name; ?>" class="form-control" id="c_name" autocomplete="name">
                                                                                    <input type="hidden" name="c_id" value="<?php echo $units->c_id; ?>" required class="form-control" id="c_id">
                                                                                </div>
                                                                                <div class="form-group col-md-6">
                                                                                    <label for="c_code">Unit Code</label>
                                                                                    <input type="text" name="c_code" value="<?php echo $units->c_code; ?>" required class="form-control" id="c_code" autocomplete="on">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="form-group col-md-12">
                                                                                    <label for="<?php echo $units->c_id; ?>">Unit Description</label>
                                                                                    <textarea type="text" name="c_desc" class="form-control" id="<?php echo $units->c_id; ?>"><?php echo $units->c_desc; ?></textarea autocomplete="on">
                                                                                </div>
                                                                            </div>
                                                                            <hr>
                                                                            <div class="text-right">
                                                        ...
                                                        <a class="badge badge-outline-warning" data-toggle="modal" href="#delete-<?php echo $units->c_id; ?>">
