...
if (isset($_POST['add_teaching_allocation'])) {
    ...
    if (!$error && isset($c_name)) {
        $stmt = $mysqli->prepare("SELECT * FROM lms_units_assaigns WHERE c_code = ?");
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" id="Unit_Name" name="c_name" required class="form-control" autocomplete="name">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            <label for="Ins_Number">Instructor Number</label>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name="i_name" id="Ins_Name" required class="form-control" autocomplete="name">
                                                            <input type="hidden" name="i_id" id="Ins_Id" required class="form-control">
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="text-right">
                                                        <button type="submit" name="add_teaching_allocation" class="btn btn-outline-warning">Add</button>
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-outline-warning" data-toggle="modal" href="#delete-<?php echo $allocations->ua_id; ?>">
