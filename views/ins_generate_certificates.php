                                            ...
                                            while ($cert = $res->fetch_object()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-outline-warning" href="ins_view_certificate.php?view=<?php echo $cert->cert_id; ?>">
                                                            <i class="fas fa-external-link-alt"></i>
                                                            View Certificate
                                                        </a>

                                                        <!-- <a class="badge badge-outline-warning" href="#delete-<?php echo $cert->cert_id; ?>" data-toggle="modal">
