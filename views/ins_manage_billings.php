                                            ...
                                            while ($payments = $res->fetch_object()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- <a class='badge badge-outline-warning' data-toggle='modal' href='#update-'>
                                                            <i class='fas fa-pencil-alt'></i>
                                                            Update Payment
                                                        </a> -->
                                                        <!-- <a class='badge badge-outline-warning' data-toggle='modal' href='#delete-?>'>
                                                                        ...
                                                                        <!-- <form method="post" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="form-group col-md-6" style="display:none">
                                                                                    ...
                                                                                    <!-- Hidden Values -->
                                                                                    <!-- <input type="hidden" name="psm_id" value="" readonly required class="form-control">
                                                                                </div>
                                                                                <div class="form-group col-md-6">
                                                                                    <label for="exampleInputEmail1">Amount To Pay</label>
                                                                                    <input type="text" name="p_amt" value="" required class="form-control">
                                                                                </div>
                                                                                <div class="form-group col-md-6">
                                                                                ...
                                                                                <div class="form-group col-md-12">
                                                                                    ...
                                                                                    <input type="text" name="p_code" value="" required class="form-control">
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body text-center text-danger">
                                                                        ...
                                                                        <a href="ins_manage_billings.php?delete=" class="text-center btn btn-outline-warning"> Delete </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div> -->
