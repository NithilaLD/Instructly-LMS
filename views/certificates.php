                    ...
                    <div class="container-fluid">
                        <div class="container">
                            <div class="text-right text-dark">
                                <a href="generate_certificates.php" class="btn btn-outline-warning">View Certificates</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                                            ...
                                                            <div class="modal-dialog  modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title">Add Certficate For <?php echo $enrollment->s_name . " " . $enrollment->s_regno; ?> </h4>
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="form-group col-md-4">
                                                                                    ...
                                                                                    <input type="text" name="s_name" value="<?php echo $enrollment->s_name; ?>" readonly required class="form-control" id="s_name" autocomplete="name">
                                                                                </div>

                                                                                <div class="form-group col-md-4">
                                                                                    <label for="i_name">Instructor Name</label>
                                                                                    <input type="text" name="i_name" value="<?php echo $enrollment->i_name; ?>" readonly required class="form-control" id="i_name" autocomplete="name">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <input type="text" name="s_unit_code" value="<?php echo $enrollment->s_unit_code; ?>" readonly required class="form-control" id="s_unit_code" autocomplete="on">
                                                                                </div>

                                                                                <div class="form-group col-md-6">
                                                                                    <label for="s_unit_name">Unit Name</label>
                                                                                    <input type="text" name="s_unit_name" value="<?php echo $enrollment->s_unit_name; ?>" readonly required class="form-control" id="s_unit_name" autocomplete="name">
                                                                                </div>
                                                                            </div>
