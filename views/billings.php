                                                                        ...
                                                                        <!-- <form method="post" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <input type="text" name="c_name" value="" readonly required class="form-control"> -->
                                                                                    <!-- Hidden Values -->
                                                                                    <!-- <input type="hidden" name="ls_id" value="" readonly required class="form-control">
                                                                                </div>

                                                                                <div class="form-group col-md-6">
                                                                                    <label for="exampleInputEmail1">Study Materials Code</label>
                                                                                    <input type="text" name="sm_number" readonly value="" required class="form-control">
                                                                                </div>
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <input type="text" name="payment_method" readonly value="<?php echo $paid_study_materials->p_method; ?>" required class="form-control">
                                                                                </div>

                                                                                <div class="form-group col-md-12">
                                                                                    <label for="exampleInputEmail1">Payment Code | Reference Number</label>
                                                                                    <input type="text" name="p_code" readonly value="<?php echo $paid_study_materials->p_code ?>" required class="form-control">
                                                                                </div>
                                                                            </div>
