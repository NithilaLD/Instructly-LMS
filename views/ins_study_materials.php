...
if (isset($_POST['add_studymaterial'])) {
    ...
    if (empty($sm_materials)) {
        ...
        if (!move_uploaded_file($file_tmp, $upload_dir . $new_file_name)) {
            $error = 1;
            $err = "File upload failed. Please check folder permissions.";
        }
    }
    ...
    if (!$error) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            // 11 columns, so 11 types: all strings except sm_price (double/float)
            $rc = $stmt->bind_param(
                'sssssssssds',
                $c_code,
                $sm_number,
                    ...
                    <div class="container-fluid">
                        <div class="container">
                            <div class="text-right text-dark">
                                <a class="btn btn-outline-warning" href="ins_manage_study_materials.php">Manage Study Materials</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                                ...
                                                                                <div class="form-group col-md-12">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <div class="custom-file">
                                                                                            <input required name="sm_materials" type="file" class="custom-file-input" id="exampleInputFile" accept=".pdf,.docx,.pptx">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <input type="number" step="0.01" min="0" name="sm_price" required class="form-control" id="sm_price">
                                                                                </div>
