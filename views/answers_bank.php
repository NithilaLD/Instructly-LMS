                    ...
                    <div class="container-fluid">
                        <div class="container">
                            <div class="text-right text-dark">
                                <a class="btn btn-outline-warning" href="manage_answers_bank.php">Manage Answers Bank</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            <div class="row" style="display:none">
                                                                                <div class="form-group col-md-6" style="display:none">
                                                                                    ...
                                                                                    <?php $generated_an_code = 'AN-'.substr(md5(uniqid(mt_rand(), true)), 0, 8); ?>
                                                                                    <input type="text" name="an_code" readonly value="<?php echo $generated_an_code; ?>" required class="form-control" id="an_code" autocomplete="on">
                                                                                </div>
                                                                                <div class="form-group col-md-6">
                                                                                    <label for="c_name">Unit Name</label>
                                                                                    <input type="text" name="c_name" value="<?php echo $questions->c_name; ?>" readonly required class="form-control" id="c_name" autocomplete="name">
                                                                                </div>

                                                                                <div class="form-group col-md-6">
                                                                                    <label for="c_code">Unit Code</label>
                                                                                    <input type="text" name="c_code" value="<?php echo $questions->c_code; ?>" required class="form-control" id="c_code" autocomplete="on">
                                                                                    <textarea type="text" name="q_details" class="form-control"><?php echo $questions->q_details; ?></textarea id="q_details" autocomplete="on">
                                                                                    <input type="text" name="q_code" value="<?php echo $questions->q_code; ?>" readonly required class="form-control" id="q_code" autocomplete="on">
                                                                                    <input type="text" name="cc_id" value="<?php echo $questions->cc_id; ?>" readonly required class="form-control" id="cc_id" autocomplete="on">
                                                                                    <input type="text" name="c_id" value="<?php echo $questions->c_id; ?>" readonly required class="form-control" id="c_id" autocomplete="on">
                                                                                    <input type="text" name="i_id" value="<?php echo $questions->i_id; ?>" readonly required class="form-control" id="i_id" autocomplete="on">
                                                                                    <input type="text" name="q_id" value="<?php echo $questions->q_id; ?>" readonly required class="form-control" id="q_id" autocomplete="on">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
