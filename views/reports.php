                                    ...
                                    <div class="card-body" style="padding-top: 0 !important;">
                                        <?php   if ($role === 'admin'):
                                                    if ($report === 'students'): 
                                                        ...
                                                        $stmt = $mysqli->prepare("SELECT user_code, name, email, phone FROM users WHERE role = 'student' ORDER BY user_code ASC");
                                                        $stmt->execute();
                                        ...
                                        <?php       
                                                    ...
                                                    elseif ($report === 'instructors'): 
                                                        ...
                                                        $stmt = $mysqli->prepare("SELECT user_code, name, email, phone FROM users WHERE role = 'instructor' ORDER BY user_code ASC");
                                                        $stmt->execute();
                                                        $result = $stmt->get_result();
                                                        $i = 1;
                                                        while ($row = $result->fetch_assoc()):
                                        ...
                                        <?php       
                                                    ...
                                                    elseif ($report === 'courses'):
                                                        ...
                                                        $stmt = $mysqli->prepare("SELECT c.c_code, c.c_name, u.name AS i_name FROM courses c LEFT JOIN users u ON c.i_id = u.user_id ORDER BY c.c_id DESC");
                                                        $stmt->execute();
                                                        $result = $stmt->get_result();
                                                        $i = 1;
                                                        while ($row = $result->fetch_assoc()):
                                        ...
                                        <?php       
                                                    ...
                                                    elseif ($report === 'units'):
                                                        ...
                                                        $stmt = $mysqli->prepare("SELECT u.u_code, u.u_name, c.c_name FROM units u LEFT JOIN courses c ON u.c_id = c.c_id ORDER BY u.u_id DESC");
                                                        $stmt->execute();
                                                        $result = $stmt->get_result();
                                                        $i = 1;
                                                        while ($row = $result->fetch_assoc()):
                                        ...
                                        <?php       
                                                    ...
                                                    elseif ($report === 'enrollments'): 
                                                        ...
                                                        $stmt = $mysqli->prepare("SELECT e.en_date, s.name AS s_name, c.c_name FROM enrollments e LEFT JOIN users s ON e.s_id = s.user_id LEFT JOIN courses c ON e.c_id = c.c_id ORDER BY e.en_id DESC");
                                                        $stmt->execute();
                                                        $result = $stmt->get_result();
                                                        $i = 1;
                                                        while ($row = $result->fetch_assoc()):
                                        ...
                                        <?php
                                                ...
                                                elseif ($role === 'instructor'):
                                                    if ($report === 'allocations'):
                                                        renderTableStart('reports', ['No.', 'Course', 'Instructor']);
                                                        $stmt = $mysqli->prepare("SELECT c.c_name, i.name AS i_name FROM courses c LEFT JOIN users i ON c.i_id = i.user_id WHERE c.i_id = ? ORDER BY c.c_id DESC");
                                        ...
                                        <?php 
                                                    ...
                                                    elseif ($report === 'enrollments'):
                                                    renderTableStart('reports', ['No.', 'Student', 'Course', 'Enrolled On']);
                                                        $stmt = $mysqli->prepare("SELECT e.en_date, s.name AS s_name, c.c_name FROM enrollments e LEFT JOIN users s ON e.s_id = s.user_id LEFT JOIN courses c ON e.c_id = c.c_id WHERE c.i_id = ? ORDER BY e.en_id DESC");
                                                        $stmt->bind_param('i', $user_id);
                                                        $stmt->execute();
                                                        $result = $stmt->get_result();
                                                        $i = 1;
                                        ...
                                        <?php
                                                    ...
                                                    elseif ($report === 'units'):
                                                        renderTableStart('reports', ['No.', 'Unit Code', 'Unit Name', 'Course']);
                                                        $stmt = $mysqli->prepare("SELECT u.u_code, u.u_name, c.c_name FROM units u LEFT JOIN courses c ON u.c_id = c.c_id WHERE c.i_id = ? ORDER BY u.u_id DESC");
                                                        $stmt->bind_param('i', $user_id);
                                                        $stmt->execute();
                                                        $result = $stmt->get_result();
                                                        $i = 1;
