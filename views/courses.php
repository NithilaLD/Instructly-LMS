...
if (isset($_POST['update_course_cat'])) {
    ...
    if (isset($_FILES["cc_dpic"]["name"]) && !empty($_FILES["cc_dpic"]["name"])) {
        $cc_dpic = $_FILES["cc_dpic"]["name"];
        move_uploaded_file($_FILES["cc_dpic"]["tmp_name"], "../public/sys_data/uploads/courses/" . $_FILES["cc_dpic"]["name"]);
    } else if (isset($_POST['current_cc_dpic'])) {
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">
                                                    Allowed file types: XLS, XLSX. <br>Please, Refer The Format from The Sample File<br><a href="../public/sys_data/uploads/xls/Courses_Template.xlsx">Download The Sample File</a>
                                                </h4>
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <?php if (!empty($courses->cc_dpic)) : ?>
                                                                                        <input type="hidden" name="current_cc_dpic" value="<?php echo htmlspecialchars($courses->cc_dpic); ?>">
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <label>Course Dept. Head Instructor</label>
