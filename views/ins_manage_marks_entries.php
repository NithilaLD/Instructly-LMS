                                        ...
                                        <tbody>
                                            ...
                                            while ($results = $res->fetch_object()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-outline-warning" href="ins_view_marks_entry.php?view=<?php echo $results->rs_id; ?>">
                                                            <i class="fas fa-external-link-alt"></i>
                                                            View
                                                        </a>

                                                        <a class="badge badge-outline-warning" data-toggle="modal" href="#update-<?php echo $results->rs_id; ?>">
                                                            ...
                                                            <div class="modal-dialog  modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title">Update Marks Entry for <?php echo $results->s_name; ?></h4>
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                                <div class="form-group col-md-6">
                                                                                    <label for="rs_code">Entry Code</label>
                                                                                    <input type="text" name="rs_code" value="<?php echo $results->rs_code; ?>" readonly required class="form-control" id="rs_code" autocomplete="on">
                                                                                    <input type="hidden" name="rs_id" value="<?php echo $results->rs_id; ?>" required class="form-control" id="rs_id">
                                                                                </div>
                                                                                <div class="form-group col-md-6">
                                                                                    <label for="c_cat1_marks">CA 1 Marks(Out Of 30)</label>
                                                                                    <input type="text" name="c_cat1_marks" value="<?php echo $results->c_cat1_marks; ?>" required class="form-control" id="c_cat1_marks" autocomplete="on">
                                                                                </div>

                                                                                <div class="form-group col-md-6">
                                                                                    <label for="c_cat2_marks">CA 2 Marks(Out Of 30)</label>
                                                                                    <input type="text" name="c_cat2_marks" value="<?php echo $results->c_cat2_marks; ?>" required class="form-control" id="c_cat2_marks" autocomplete="on">
                                                                                </div>

                                                                                <div class="form-group col-md-6">
                                                                                    <label for="c_eos_marks">Sem End Exam Marks(Out Of 100)</label>
                                                                                    <input type="text" name="c_eos_marks" value="<?php echo $results->c_eos_marks; ?>" class="form-control" id="c_eos_marks" autocomplete="on">
                                                                                </div>
                                                        ...
                                                        <!-- <a class="badge badge-outline-warning" data-toggle="modal" href="#delete-<?php echo $results->rs_id; ?>">
