<?php
    ...
    if (isset($_POST['add_studymaterial'])) {
        ...
        if (empty($sm_materials)) {
            ...
            $error = 1;
            $err = "Invalid file type. Only PDF, DOCX, PPTX allowed.";
        ...
        if (!$error) {
            ...
            if (mysqli_num_rows($res) > 0) {
                ...
                $query = "INSERT INTO lms_study_material  (c_code, sm_number, c_id, cc_id, c_name, c_category, i_id, i_name, sm_materials, sm_price, payment_status) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
                ...
                if ($stmt) {
                    ...
                    if ($emailSent) {
                        ...
                        $success = "Added";
                        header("refresh:1; url=study_materials.php");
                    } else {
                        ...
                        <div class="container-fluid">
                            <div class="container">
                                <div class="text-right text-dark">
                                    <a class="btn btn-outline-warning" href="manage_study_materials.php">View or Delete Study Materials</a>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                                                            ...
                                                                            <form method="post" enctype="multipart/form-data">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="form-group col-md-4">
                                                                                        ...
                                                                                        <input type="text" name="sm_number" readonly value="<?php echo $a; ?>-<?php echo $b; ?>" required class="form-control" id="sm_number" autocomplete="on">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="row">
