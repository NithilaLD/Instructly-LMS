                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-outline-warning" href="view_answers_bank.php?view=<?php echo $answers->an_id; ?>">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="form-group col-md-12">
                                                                                    <label for="editor_an_id">Answers</label>
                                                                                    <textarea type="text" name="ans_details" class="form-control" id="editor_an_id" autocomplete="on"><?php echo $answers->ans_details; ?></textarea>
                                                                                </div>
                                                                            </div>
