...
/* Ensure dashboard counters are defined to avoid undefined variable errors */
$courses = isset($courses) ? $courses : 0;
$course_categories = isset($course_categories) ? $course_categories : 0;
$instructors = isset($instructors) ? $instructors : 0;
$std = isset($std) ? $std : 0;
$s_enroll = isset($s_enroll) ? $s_enroll : 0;
$ins_all = isset($ins_all) ? $ins_all : 0;
$bills = isset($bills) ? $bills : 0;
...
while ($sys = $res->fetch_object()) {
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="margin-bottom: 0px;"><br>
                <!-- Main content -->
