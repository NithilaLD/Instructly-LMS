                    ...
                    <div class="content-wrapper"><br>
                        ...
                        <section class="content">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-outline-warning card-outline" id="Print">
                                                        ...
                                                        <div class="">
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <!-- Course Details -->
                                                                        <div class="card card-outline-warning card-outline">
                                                                ...
                                                                <?php echo nl2br(htmlspecialchars($answer->q_details)); ?>

                                                                <h2 class="text-center">
                                                                    <u>Answers</u>
                                                                </h2>
                                                                <?php echo nl2br(htmlspecialchars($answer->ans_details)); ?>
                                                            </div>
                                                        </div>
