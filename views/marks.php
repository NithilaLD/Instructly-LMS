...
if (isset($_POST['enter_marks'])) {
    ...
    if (!$error) {
        ...
        $sql = "SELECT * FROM  lms_results WHERE  rs_code=?";
        $stmt = $mysqli->prepare($sql);
        $stmt->bind_param('s', $rs_code);
        $stmt->execute();
        $res = $stmt->get_result();
        if ($res->num_rows > 0) {
            $row = $res->fetch_assoc();
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            <div class="row">
                                                                                <div class="form-group col-md-4" style="display:none">
                                                                                    <label for="rs_code">Results Code</label>
                                                                                    <input type="text" name="rs_code" value="<?php echo (isset($a) && isset($b)) ? $a . $b : uniqid('rs_'); ?>" required class="form-control" id="rs_code" autocomplete="on">
                                                                                    <input type="text" name="s_id" value="<?php echo $enrollment->s_id; ?>" required class="form-control" id="s_id" autocomplete="on">
                                                                                    <input type="text" name="cc_id" value="<?php echo $enrollment->cc_id; ?>" required class="form-control" id="cc_id" autocomplete="on">
                                                                                    <input type="text" name="c_id" value="<?php echo $enrollment->c_id; ?>" required class="form-control" id="c_id" autocomplete="on">
                                                                                ...
                                                                                <div class="form-group col-md-4">
                                                                                    ...
                                                                                    <input type="text" name="s_regno" readonly required value="<?php echo $enrollment->s_regno; ?>" class="form-control" id="s_regno" autocomplete="on">
                                                                                </div>

                                                                                <div class="form-group col-md-4">
                                                                                    <label for="s_name">Name</label>
                                                                                    <input type="text" name="s_name" readonly value="<?php echo $enrollment->s_name; ?>" required class="form-control" id="s_name" autocomplete="name">
                                                                                </div>

                                                                                <div class="form-group col-md-4">
                                                                                    <label for="i_name">Instructor Name</label>
                                                                                    <input type="text" name="i_name" readonly value="<?php echo $enrollment->i_name; ?>" required class="form-control" id="i_name" autocomplete="name">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <input type="text" name="s_unit_code" readonly value="<?php echo $enrollment->s_unit_code; ?>" required class="form-control" id="s_unit_code" autocomplete="on">
                                                                                </div>

                                                                                <div class="form-group col-md-6">
                                                                                    <label for="s_unit_name">Unit Name</label>
                                                                                    <input type="text" name="s_unit_name" readonly required value="<?php echo $enrollment->s_unit_name; ?>" class="form-control" id="s_unit_name" autocomplete="name">
                                                                                </div>
                                                                            </div>

                                                                            <div class="row">
                                                                                <div class="form-group col-md-4">
                                                                                    <label for="c_cat1_marks">CA 1 Marks(Out Of 30)</label>
                                                                                    <input type="text" name="c_cat1_marks" required class="form-control" id="c_cat1_marks" autocomplete="on">
                                                                                </div>

                                                                                <div class="form-group col-md-4">
                                                                                    <label for="c_cat2_marks">CA 2 Marks(Out Of 30)</label>
                                                                                    <input type="text" name="c_cat2_marks" required class="form-control" id="c_cat2_marks" autocomplete="on">
                                                                                </div>

                                                                                <div class="form-group col-md-4">
                                                                                    <label for="c_eos_marks">Sem End Exam Marks(Out Of 100)</label>
                                                                                    <input type="text" name="c_eos_marks" class="form-control" id="c_eos_marks" autocomplete="on">
                                                                                </div>
